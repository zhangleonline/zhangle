...
class MainForm(QWidget):
    ...
    def slot_btn_startTask(self):     #按钮3保存回调函数
        ...
        self.display3.setText("load data...")
        ...
        print("读入数据时间为：%.8s s" %(time.time()-time1))
        ...
        self.display3.setText("All Done! Success!运行时间：%.4ss" % dtime)
...
if __name__=="__main__":
    ...
    mainForm = MainForm('QFYF_analyze V1.1')
    mainForm.show()
    sys.exit(app.exec_())
